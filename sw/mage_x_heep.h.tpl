...
////////////////////////////////////////////////////////////////
// DMA Configurations
#define MAGE_DMA_CFG_START_ADDR (MAGE_PERIPH_START_ADDRESS + MAGE_DMA_CFG_REG_OFFSET)
...
#define MAGE_SEPARATE_COLS_START_ADDR (MAGE_PERIPH_START_ADDRESS + MAGE_SEPARATE_COLS_REG_OFFSET)
// Synch DMAs
#define MAGE_SYNCH_DMA_START_ADDR (MAGE_PERIPH_START_ADDRESS + MAGE_SYNCH_DMA_CH_REG_OFFSET)        
// Trans size DMA 0
#define MAGE_TRANS_SIZE_0_START_ADDR (MAGE_PERIPH_START_ADDRESS + MAGE_TRANS_SIZE_0_REG_OFFSET)       
// Trans size DMA 1
#define MAGE_TRANS_SIZE_1_START_ADDR (MAGE_PERIPH_START_ADDRESS + MAGE_TRANS_SIZE_1_REG_OFFSET)     
// Trans size DMA 2
#define MAGE_TRANS_SIZE_2_START_ADDR (MAGE_PERIPH_START_ADDRESS + MAGE_TRANS_SIZE_2_REG_OFFSET)     
// Trans size DMA 3
#define MAGE_TRANS_SIZE_3_START_ADDR (MAGE_PERIPH_START_ADDRESS + MAGE_TRANS_SIZE_3_REG_OFFSET)                                           
