...
package stream_intf_pkg;
    ...
    localparam unsigned N_DMA_CH = ${n_dma_ch};
    ...
    localparam unsigned N_IN_STREAM = ${n_in_stream};
    // In each inputs stream, N_DMA_CH_PER_IN_STREAM DMA channels can be grouped
    localparam unsigned N_DMA_CH_PER_IN_STREAM = ${n_dma_ch_per_in_stream};
    // In each inputs stream, N_PEA_DIN_PER_IN_STREAM PEA inputs can be grouped
    localparam unsigned N_PEA_DIN_PER_IN_STREAM = ${n_pea_din_per_in_stream};
    ...
    localparam unsigned N_OUT_STREAM = ${n_out_stream};
    // In each inputs stream, N_PEA_DOUT_PER_OUT_STREAM PEA outputs can be grouped
    localparam unsigned N_PEA_DOUT_PER_OUT_STREAM = ${n_pea_dout_per_out_stream};
    // In each inputs stream, N_DMA_CH_PER_OUT_STREAM DMA channels can be grouped
    localparam unsigned N_DMA_CH_PER_OUT_STREAM = ${n_dma_ch_per_out_stream};
    ...
    localparam unsigned LOG_N_DMA_CH_PER_IN_STREAM = (N_DMA_CH_PER_IN_STREAM == 1) ? 1 : $clog2(N_DMA_CH_PER_IN_STREAM);
    localparam unsigned LOG_N_PEA_DOUT_PER_OUT_STREAM = (N_PEA_DOUT_PER_OUT_STREAM == 1) ? 1 : $clog2(N_PEA_DOUT_PER_OUT_STREAM);
